//! App settings persistence and storage configuration commands.
//!
//! Also hosts window lifecycle commands (open/close settings window) since
//! they share imports and form a natural cluster.
